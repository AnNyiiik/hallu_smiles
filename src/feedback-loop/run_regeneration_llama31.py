...
from build_regen_prompt_llama31 import build_prompt
...
def main():
    ...
    ap.add_argument("--originals", default="ragtruth-originals-llama31.jsonl")
    ...
    with open(args.out, mode, encoding="utf-8") as out:
        for i, rid in enumerate(ids, 1):
            ...
            row = {
                ...
                "k": args.k,
                "prompt_version": "llama31_no_evidence_no_entities",
